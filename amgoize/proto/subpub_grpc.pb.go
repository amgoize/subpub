...
const (
	SubPub_Subscribe_FullMethodName = "/SubPub/Subscribe"
	SubPub_Publish_FullMethodName   = "/SubPub/Publish"
)
...
func (c *subPubClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (UnimplementedSubPubServer) Publish(context.Context, *PublishRequest) (*empty.Empty, error) {
