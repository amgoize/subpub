...
const file_proto_subpub_proto_rawDesc = "" +
	"\n" +
	"\x12proto/subpub.proto\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\aPublish\x12\x0f.PublishRequest\x1a\x16.google.protobuf.EmptyB\x15Z\x13amgoize/proto;protob\x06proto3"
...
var file_proto_subpub_proto_depIdxs = []int32{
	0, // 0: SubPub.Subscribe:input_type -> SubscribeRequest
	1, // 1: SubPub.Publish:input_type -> PublishRequest
	2, // 2: SubPub.Subscribe:output_type -> Event
	3, // 3: SubPub.Publish:output_type -> google.protobuf.Empty
